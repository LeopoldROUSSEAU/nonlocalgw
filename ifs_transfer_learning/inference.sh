...
#do
	#python ANN_inference.py global uvtheta 200 ERA5 $month 3
	#python ANN_inference.py global uvthetaw 200 ERA5 $month 3
...
#        python ANN_inference.py stratosphere_update uvthetaw 200 ERA5 $month 1 1
#	python ANN_inference.py stratosphere_update uvthetaw 200 ERA5 $month 1 2
#	python ANN_inference.py stratosphere_update uvthetaw 200 ERA5 $month 1 3
...
#        python attn_inference.py stratosphere_update uvthetaw 200 ERA5 $month 1
#	python attn_inference.py stratosphere_update uvthetaw 200 ERA5 $month 2
#	python attn_inference.py stratosphere_update uvthetaw 200 ERA5 $month 3
...
#python training_ifs_transfer_learning.py ann global stratosphere_update uvthetaw XXX 1 1
...
#python ANN_inference.py stratosphere_update uvthetaw 200 IFS 1 1 1
#python attn_inference.py stratosphere_update uvthetaw 200 IFS 1 1
python ANN_inference.py stratosphere_update uvthetaw 200 IFS 1 1 2
python attn_inference.py stratosphere_update uvthetaw 200 IFS 1 2
python ANN_inference.py stratosphere_update uvthetaw 200 IFS 1 1 3
python attn_inference.py stratosphere_update uvthetaw 200 IFS 1 3
