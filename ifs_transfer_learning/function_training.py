...
def Model_Freeze_Transfer_Learning(model, model_type, K=1):
    # freezes all but last K layers for the respective models
    # default is K=1, which means only freeze the final output layers
    ...
    if model_type == "ann":
        ...
        if K == 1:
            ...
            model.layer5.weight.requires_grad = True
            model.layer5.bias.requires_grad = True
            model.bnorm5.weight.requires_grad = True
            model.bnorm5.bias.requires_grad = True
            # -----------------------------------------
            model.layer6.weight.requires_grad = True
            model.layer6.bias.requires_grad = True
            model.bnorm6.weight.requires_grad = True
            ...
            model.layer4.bias.requires_grad = True
            model.bnorm4.weight.requires_grad = True
            model.bnorm4.bias.requires_grad = True
            # -----------------------------------------
            model.layer5.weight.requires_grad = True
            model.layer5.bias.requires_grad = True
            model.bnorm5.weight.requires_grad = True
        ...
        if K == 1:
            ...
            for params in model.upconv3.parameters():
                params.requires_grad = True

            for params in model.up2.parameters():
                params.requires_grad = True

            for params in model.attn2.parameters():
                params.requires_grad = True
            ...
            for params in model.upconv4.parameters():
                params.requires_grad = True

            for params in model.up3.parameters():
                params.requires_grad = True

            for params in model.attn3.parameters():
                params.requires_grad = True
