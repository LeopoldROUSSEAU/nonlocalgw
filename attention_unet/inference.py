...
ckpt = f"3d_attnunet_era5_{domain}_{vertical}_{features}_mseloss_train_epoch{str(epoch).zfill(2)}.pt"
...
# ---- define model
model = Attention_UNet(ch_in=ch_in, ch_out=ch_out, dropout=dropout, attn_3d=True)
loss_fn = nn.MSELoss()
write_log(
